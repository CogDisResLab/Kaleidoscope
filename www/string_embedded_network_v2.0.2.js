...
function getSTRING(root_url, params, single_flag) {
...
Shiny.addCustomMessageHandler("string_input", function(genes) {
    
    if(genes["single_par"]) {
        delete genes['single_par'];
        getSTRING('https://string-db.org', genes, true); 
    }
    
    else {
        delete genes['single_par'];
        getSTRING('https://string-db.org', genes, false); 
    }
