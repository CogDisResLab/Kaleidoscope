...
#knitr::include_graphics("gwas.jpeg")
...
bs_res <- ks_braincloud(genes = genes, db = my_db)
...
string_output <- ks_string(process_gene_input(genes[1], type = "single"), score = 500, nodes = 25)
